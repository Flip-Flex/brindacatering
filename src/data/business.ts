...
export const aboutPageData = {
  ourStory: {
    intro: "Brinda Catering was founded on a simple principle: to bring authentic South Indian hospitality to every celebration.",
